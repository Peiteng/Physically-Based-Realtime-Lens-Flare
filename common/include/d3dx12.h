...
typedef CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT< D3D12_SHADER_BYTECODE,              D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_CS>                                CD3DX12_PIPELINE_STATE_STREAmCS;
...
typedef CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT< D3D12_CACHED_PIPELINE_STATE,        D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_CACHED_PSO>                        CD3DX12_PIPELINE_STATE_STREAmCACHED_PSO;
...
struct CD3DX12_PIPELINE_STATE_STREAM1
{
    ...
    CD3DX12_PIPELINE_STATE_STREAmCS CS;
    ...
    CD3DX12_PIPELINE_STATE_STREAmCACHED_PSO CachedPSO;
...
public:
    ...
    { 
        ...
        mCollectionRef = pExistingCollection; 
    }
    void DefineExport(
        LPCWSTR Name, 
        LPCWSTR ExportToRename = nullptr, 
...
private:
    void Init()
    {
        SUBOBJECT_HELPER_BASE::Init();
        m_Desc = {};
        mCollectionRef = nullptr;
        m_Strings.clear();
        m_Exports.clear();
    }
    void* Data() { return &m_Desc; }
    D3D12_EXISTING_COLLECTION_DESC m_Desc;
    Microsoft::WRL::ComPtr<ID3D12StateObject> mCollectionRef;
    CD3DX12_STATE_OBJECT_DESC::StringContainer m_Strings;
    std::vector<D3D12_EXPORT_DESC> m_Exports;
};
